                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-200">
                            ...
                            <th class="text-left py-4 px-4 text-sm font-semibold text-gray-500">Date</th>
                            <th class="text-left py-4 px-4 text-sm font-semibold text-gray-500">Description</th>
                            <th class="text-left py-4 px-4 text-sm font-semibold text-gray-500">Category</th>
                            <th class="text-left py-4 px-4 text-sm font-semibold text-gray-500">Payment</th>
                            <th class="text-right py-4 px-4 text-sm font-semibold text-gray-500">Amount</th>
                            <th class="text-right py-4 px-4 text-sm font-semibold text-gray-500">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        @foreach($expenses as $expense)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                {{-- Payment Method --}}
                                <td class="py-4 px-4 text-sm text-gray-600 capitalize">
